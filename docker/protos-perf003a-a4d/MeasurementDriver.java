...
public final class MeasurementDriver {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (warmup < 0 || steady < 0) throw new IllegalArgumentException("negative iterations");

        String source = Files.readString(sourcePath);
        Path core = Path.of("/opt/protos/protos/lib/core");
        ...
        for (int i = 1; i <= warmup + steady; i++) {
            ...
            if (i <= warmup) {
                ...
                System.out.println("STEADY\t" + (i - warmup) + "\t" + elapsed + "\t" + actual);
            }
        }
    }
}
